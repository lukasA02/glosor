...
<body>
    ...
    <div class="testing">
        <p class="svara">Översätt ordet från tyska till svenska</p>
        <p class="komihåg" >Kom ihåg att alltid trycka på "rensa session" innan du börjar:)</p>
    </div>
...
$glosorassoc = array();
    ...
    if (!isset ($_SESSION["glosorassoc"])){
        foreach (file("glosorty.txt") as $rad){
            $data=explode(",",$rad);
...
<form action="test2ty.php" method="get">
...
<form action="clearsess2.php" method="POST">
